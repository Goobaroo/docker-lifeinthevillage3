# [LITV3 - 2.8 [MC1.19.2]](https://www.curseforge.com/minecraft/modpacks/life-in-the-village-3) on Curseforge
...
The docker on first run will download the same version as tagged of `LITV3 - 2.8 [MC1.19.2]` and install it.  This can take a while as the Forge installer can take a bit to complete.  You can watch the logs and it will eventually finish.
...
* MOTD "LITV3 - 2.8 [MC1.19.2] Server Powered by Docker"
* LEVEL world
