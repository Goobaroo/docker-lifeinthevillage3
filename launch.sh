...
if ! [[ -f 'LITV3-1.19.2-Serverpack-2.4.zip' ]]; then
	rm -fr config kubejs libraries mods *SERVER.zip forge*.jar
	curl -Lo 'LITV3-1.19.2-Serverpack-2.4.zip' 'https://edge.forgecdn.net/files/4819/479/LITV3-1.19.2-Serverpack-2.4.zip' && unzip -u -o 'LITV3-1.19.2-Serverpack-2.4.zip' -d /data
